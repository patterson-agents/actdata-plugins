---
name: assess-zfs
description: "Assess ZFS pool health, capacity, topology, dataset tuning, ARC behavior, and snapshots."
---

# Assess Zfs

Read and follow the canonical procedure in [../../commands/assess-zfs.md](../../commands/assess-zfs.md).
