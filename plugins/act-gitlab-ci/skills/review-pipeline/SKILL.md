...
description: "Review a GitLab pipeline against ACT-derived standards using the checker plus manual analysis of its blind spots."
---

# Review Pipeline

Read and follow the canonical procedure in [../../commands/review-pipeline.md](../../commands/review-pipeline.md).
